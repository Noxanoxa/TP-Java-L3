...
public class AStarSearch {
	static Node node_goal;
    public AStarSearch(int[][] start, int[][] puzzle) {
	...
	public static void main(String[] args) {
        ...
        //Create a node containing the goal state node_goal
         node_goal = new Node(null, null, 1, 15, 15);
        ...
        while (!OPEN.isEmpty()) {
            ...
            if (node_current.isMatch(node_goal)) {
                node_goal.setParentNode(node_current.getParentNode());
                break;
            }
	...
	public static void runAStarSearch() {
	    //Create a node containing the goal state node_goal
	    ...
	    //Print solution path cost
	    System.out.println("Solution cost: " + node_goal.getG());

	    //Print solution path
	    for (Node node : solutionPathList) {
